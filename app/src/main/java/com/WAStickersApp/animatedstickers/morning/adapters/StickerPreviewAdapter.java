...
import com.WAStickersApp.animatedstickers.morning.viewholders.StickerPreviewViewHolder;
...
public class StickerPreviewAdapter extends RecyclerView.Adapter<StickerPreviewViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final StickerPreviewViewHolder stickerPreviewViewHolder, final int i) {
        ...
        Glide.with(context).load(
                StickerPackLoader.getStickerAssetUri(stickerPack.identifier, stickerPack.getStickers().get(i).imageFileName)
        )

                .apply(requestOptions)
                .into(stickerPreviewViewHolder.stickerPreviewView);
    }
