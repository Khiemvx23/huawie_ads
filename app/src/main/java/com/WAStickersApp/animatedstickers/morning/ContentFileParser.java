...
class ContentFileParser {
    ...
    private static StickerPack readStickerPack(@NonNull JsonReader reader) throws IOException, IllegalStateException {
        ...
        reader.endObject();
        final StickerPack stickerPack = new StickerPack(identifier, name, username, date, publisher, trayImageFile, publisherEmail, publisherWebsite, privacyPolicyWebsite, licenseAgreementWebsite, imageDataVersion, avoidCache, animatedStickerPack);
