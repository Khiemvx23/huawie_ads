...
public class StickerContentProvider extends ContentProvider {
    ...
    public static final String STICKER_PACK_date_IN_QUERY = "sticker_pack_date";
    public static final String STICKER_PACK_username_IN_QUERY = "sticker_pack_username";
    ...
    public static final Uri AUTHORITY_URI = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT).authority(BuildConfig.CONTENT_PROVIDER_AUTHORITY).appendPath(com.WAStickersApp.animatedstickers.morning.StickerContentProvider.METADATA).build();
    ...
    private Cursor getStickerPackInfo(@NonNull Uri uri, @NonNull List<StickerPack> stickerPackList) {
        MatrixCursor cursor = new MatrixCursor(
                new String[]{
                        ...
                        STICKER_PACK_username_IN_QUERY,
                        STICKER_PACK_date_IN_QUERY,
        ...
        for (StickerPack stickerPack : stickerPackList) {
            ...
            builder.add(stickerPack.date);
            builder.add(stickerPack.username);
