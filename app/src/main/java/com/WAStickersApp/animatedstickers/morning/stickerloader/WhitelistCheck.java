...
package com.WAStickersApp.animatedstickers.morning.stickerloader;
...
public class WhitelistCheck {
    ...
    public static final String CONSUMER_WHATSAPP_PACKAGE_NAME = "com.gbwhatsapp";
    public static final String SMB_WHATSAPP_PACKAGE_NAME = "com.whatsapp";
