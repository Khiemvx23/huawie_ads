...
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.ANIMATED_STICKER_PACK;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.AVOID_CACHE;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.IMAGE_DATA_VERSION;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.LICENSE_AGREENMENT_WEBSITE;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.PUBLISHER_EMAIL;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.PUBLISHER_WEBSITE;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.STICKER_PACK_date_IN_QUERY;
import static com.WAStickersApp.animatedstickers.morning.StickerContentProvider.STICKER_PACK_username_IN_QUERY;
...
public class StickerPackLoader {
    ...
    private static ArrayList<StickerPack> fetchFromContentProvider(Cursor cursor) {
        ...
        do {
            ...
            final String username = cursor.getString(cursor.getColumnIndexOrThrow(STICKER_PACK_username_IN_QUERY));
            final String date = cursor.getString(cursor.getColumnIndexOrThrow(STICKER_PACK_date_IN_QUERY));
            ...
            final StickerPack stickerPack = new StickerPack(identifier,name,username, date, publisher, trayImage, publisherEmail, publisherWebsite, privacyPolicyWebsite, licenseAgreementWebsite, imageDataVersion, avoidCache, animatedStickerPack);
